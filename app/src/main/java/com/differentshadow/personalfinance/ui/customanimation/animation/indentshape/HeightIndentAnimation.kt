...
import com.differentshadow.personalfinance.ui.customanimation.shape.*
import com.differentshadow.personalfinance.ui.customanimation.utils.*
        ...
        return produceState(
            initialValue = IndentRectShape(
                indentShapeData = IndentShapeData(
                    ballOffset = ballSize.toPxf(density),
